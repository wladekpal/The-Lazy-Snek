...
class Tunnel(Field):
    ...
    def __init__(self, direction):
        ...
        upper_texture = pygame.image.load(os.path.join(os.path.dirname(__file__), "../../assets/tunnel-upper.png"))
        lower_texture = pygame.image.load(os.path.join(os.path.dirname(__file__), "../../assets/tunnel-lower.png"))
