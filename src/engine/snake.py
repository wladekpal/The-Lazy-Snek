...
class Snake:
    ...
    def reload_textures(self):
        head_path = os.path.join('assets/snake/snek-head-' + self.color + '.png')
        bent_head_path = os.path.join('assets/snake/snek-bent-head-' + self.color + '.png')
        body_path = os.path.join('assets/snake/snek-body-' + self.color + '.png')
        bent_body_path = os.path.join('assets/snake/snek-bent-body-' + self.color + '.png')
        tail_path = os.path.join('assets/snake/snek-tail-' + self.color + '.png')
        egg_path = os.path.join('assets/snake/snek-egg.png')
