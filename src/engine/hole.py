...
class Hole(Field):
    ...
    def __init__(self):
        ...
        self.plugged = False
        self.texture = pygame.image.load(os.path.join(os.path.dirname(__file__), "../../assets/hole.png"))
        plugged_texture = pygame.image.load(os.path.join(os.path.dirname(__file__), "../../assets/plugged-hole.png"))
