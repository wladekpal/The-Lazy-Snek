...
class EndTeleport(Field):
    def __init__(self):
        super().__init__()
        self.texture = pygame.image.load(os.path.join("assets/block/end-teleport.png"))
        self.active_texture = pygame.image.load(os.path.join("assets/block/active.png"))
        self.active = False
...
class BeginTeleport(Field):
    def __init__(self):
        super().__init__()
        self.texture = pygame.image.load(os.path.join("assets/block/begin-teleport.png"))
